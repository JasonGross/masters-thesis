...
\section{The Splitting Strategy}
  ...
  \subsection{Diving into Refinement Code}
    ...
    Although the rule itself is non-trivial, our goal is to make using this rule as trivial as possible; we now explain how this refinement rule requires only one line of code to use.
