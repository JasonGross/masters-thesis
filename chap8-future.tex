\chapter{Future Work}
  ...
  \paragraph{Validating Extraction}
    By adapting \editedtext{ongoing work by Pit--Claudel et al.}, our parsers will be able to be compiled to verified Bedrock, and thus to assembly, within Coq.  \editedtext[1]{Currently, we use Coq's unverified extraction mechanism to turn our parsers into OCaml.}
