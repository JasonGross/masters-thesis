...
\end{align*}
      \editedtext{We begin the proof with a call to the tactic \tactic{start~honing~parser~using indexed~representation}; Coq's mechanism for custom tactic notations makes it easy to define such space-separated identifiers.}
