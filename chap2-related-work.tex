...
\chapter{Related Work and Other Approaches to Parsing} \label{sec:related}
  ...
  \section{Recursive-Descent Parsing}
    ...
    \subsection{Parser Combinators}
      ...
      Essentially, parsers defined via parser combinators answer the question ``what prefixes of a given string can be parsed as a given item?''  Each function returns a list of postfixes of the string it is passed, indicating all of the strings that might remain for the other items in a given rule.  \todo{Mention and describe semantic actions; informally explain how to generalize examples below to semantic actions}
